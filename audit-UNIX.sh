#!/bin/sh
# AUDIT_UNIX_LINUX_Checks - Check CCN-STICS on Unix & Linux
# 
...
usage () {
	echo "AUDIT_UNIX_LINUX_Checks v$VERSION"
	echo
	echo "Usage: AUDIT_UNIX_LINUX_Checks { standard | detailed } > hostname.txt"
	echo
	...
	echo '                 party programs. Be Carefully with it'
	echo
	echo "This script checks file permissions and other settings that are included in" 
	echo "CCN-STICS."
	echo 
	echo "Use of this script is only permitted on systems which you have been granted" 
	echo "legal permission to perform a security assessment of."
	echo
	echo "If you have any Question: nviss@duck.com"
	echo
...
banner () {
	echo "Starting AUDIT_UNIX_LINUX_Checks v$VERSION"
	echo ' .d888888  dP     dP 888888ba  dP d888888P       dP     dP 888888ba  dP dP    dP '
...
check_perms () {
	...
	CHECK_PERMS_FILE=$2
	CHECK_PERMS_USER=$3
	CHECK_PERMS_PATH=$4 # optional pichurri
f
